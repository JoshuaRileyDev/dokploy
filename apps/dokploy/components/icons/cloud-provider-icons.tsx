import { AwsIcon as VaultAwsIcon } from "./vault-provider-icons";
import { siAkamai, siDigitalocean, siHetzner, siVultr } from "simple-icons";
...
export const HetznerIcon = ({ className }: { className?: string }) => {
	return <SimpleIcon icon={siHetzner} className={className} />;
};

export const AwsIcon = ({ className }: { className?: string }) => {
	return <VaultAwsIcon className={className} />;
};

export const DigitalOceanIcon = ({ className }: { className?: string }) => {
	return <SimpleIcon icon={siDigitalocean} className={className} />;
};

export const VultrIcon = ({ className }: { className?: string }) => {
	return <SimpleIcon icon={siVultr} className={className} />;
};
